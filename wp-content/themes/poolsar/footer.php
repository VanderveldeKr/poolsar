...
<button class="cart-btn">
    ...
    <a class="basket-link-footer" href="https://poolsar.live/korzina/">
        <svg class="cart-btn__icon" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M7.87497 19.25H13.125C16.6425 19.25 17.2725 17.8413 17.4562 16.1263L18.1125 10.8763C18.3487 8.74125 17.7362 7 14 7H6.99997C3.26372 7 2.65122 8.74125 2.88747 10.8763L3.54372 16.1263C3.72747 17.8413 4.35747 19.25 7.87497 19.25Z" stroke="#292D32" stroke- персональных данных необходима для исполнения договора, стороной которого является субъект персональных данных.</span>
